export const movieDetailsData = document.getElementById("movieData");
...
////reconciliation proc , jsx files , props , components,create project ,file and folder structure of react project ,  add style to project ,MUI , create final project, hooks,
